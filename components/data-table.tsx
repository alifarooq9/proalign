...
export function DataTablePagination<TData>({
    ...
    return (
        <div className="flex flex-col items-start justify-between space-y-3 px-2 sm:flex-row sm:items-center sm:space-y-0">
            <div className="flex-1 text-sm text-muted-foreground">
                Total Projects: {table.getRowModel().rows?.length ?? 0}
            </div>
...
export function DataTableToolbar<TData>({
    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex flex-1 flex-col items-start gap-2 space-x-0 sm:flex-row sm:items-center sm:space-x-2">
                <Input
                    placeholder="Search..."
                    value={
...
export function DataTable<TData, TValue>({
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="rounded-lg border-2 border-dashed bg-background">
                <TableUI>
                    <TableHeader>
